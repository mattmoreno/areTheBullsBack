...
$url = 'http://data.nba.com/data/v2015/json/mobile_teams/nba/2019/teams/bulls_schedule_01.json';
$file = fopen(dirname(__FILE__) . '/feed/1920/bulls_schedule_01.json', 'w+');
